...
FILE_PATH = "C:\\Users\\arhod\\Desktop\\Diploma-vscode\\synthetic_researchers_20000_inc5000dist.csv"   # π.χ. r"C:\Users\...\INC 5000 Companies 2019.csv"
# 2) (προαιρετικό) φάκελος εξόδου για τα αποτελέσματα
OUT_DIR = "synthetic_researchers_20000"
...
targets = ["researchfield", "university", "age"]
...
researchfield_values = results["researchfield"][col_map["researchfield"]].tolist()
university_values    = results["university"][col_map["university"]].tolist()
age_values           = results["age"][col_map["age"]].tolist()
