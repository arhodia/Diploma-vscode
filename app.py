...
from backend.router import run_pipeline
import os
from backend.algorithms.kmeans import run_kmeans
app = Flask(__name__)
...
def upload_files():
    ...
    final_results, final_results_recommendations  = run_pipeline(selected_option,file_type, algorithm)
